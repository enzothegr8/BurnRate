 ...
 * The revision number is orange because the revision is the thing that
 * changed (brand-bible.md section 9). No ratings, no view counts; invented
 * numbers have no place on a publication whose product is that its numbers
...
export function ArticleMetaLine({
  ...
  return (
    <p className="font-mono text-[0.65rem] uppercase tracking-widest text-muted">
      {article.date}
      {" · "}Rev <span className="text-orange">{article.rev}</span>
